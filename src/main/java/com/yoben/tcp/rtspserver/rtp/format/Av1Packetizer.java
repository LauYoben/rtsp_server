...
/**
 * @Description AV1 RTP 打包器实现。
 * @Author Yoben
 * @Since 2026-03-11 17:38:00
 */
public class Av1Packetizer extends AbstractPacketizer {

    public Av1Packetizer(int payloadType) {
        super(payloadType);
    }
